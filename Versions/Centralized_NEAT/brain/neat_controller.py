...
class NEATController(ActorController):
    ...
    def step(self, dt: float) -> None:
        ...
        """
        input_data = retrieve_joint_info_from_actor(self._actor) + retrieve_body_info_from_actor(self._actor)

        self._target = np.array(self._model.advance(input_data, dt, dt))
    ...
    @classmethod
    def deserialize(cls, data: StaticData) -> NEATController:
        """
        ...
        network = NEATController(data["input_neurons"], len(data["dof_ranges"]))
